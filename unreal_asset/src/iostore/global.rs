...
use super::name::FNameEntrySerialized;
use super::providers::IoStoreProvider;
use super::toc::chunk::EIoChunkType5;
use super::{PackageObjectIndex, ScriptObjectEntry};
...
impl IoGlobalData {
    ...
    ) -> Result<SharedResource<Self>, Error> {
