...
lazy_static! {
    static ref GUID_TO_VERSION_INFO: HashMap<Guid, VersionInfo> = HashMap::from([
        ( (0, 0, 0, 0xF99D40C1).into(),                            (String::from("UnusedCustomVersionKey"), None) ),
        ( (0xB0D832E4, 0x1F894F0D, 0xACCF7EB7, 0x36FD4AA2).into(), (String::from("FBlueprintsObjectVersion"), None) ),
        ( (0xE1C64328, 0xA22C4D53, 0xA36C8E86, 0x6417BD8C).into(), (String::from("FBuildObjectVersion"), None) ),
        ( (0xB02B49B5, 0xBB2044E9, 0xA30432B7, 0x52E40360).into(), (String::from("FMobileObjectVersion"), None) ),
        ( (0xA4E4105C, 0x59A149B5, 0xA7C540C4, 0x547EDFEE).into(), (String::from("FNetworkingObjectVersion"), None) ),
        ( (0x39C831C9, 0x5AE647DC, 0x9A449C17, 0x3E1C8E7C).into(), (String::from("FOnlineObjectVersion"), None) ),
        ( (0x78F01B33, 0xEBEA4F98, 0xB9B484EA, 0xCCB95AA2).into(), (String::from("FPhysicsObjectVersion"), None) ),
        ( (0x6631380F, 0x2D4D43E0, 0x8009CF27, 0x6956A95A).into(), (String::from("FPlatformObjectVersion"), None) ),
        ( (0x12F88B9F, 0x88754AFC, 0xA67CD90C, 0x383ABD29).into(), (String::from("FRenderingObjectVersion"), None) ),
        ( (0xD7296918, 0x1DD64BDD, 0x9DE264A8, 0x3CC13884).into(), (String::from("FVRObjectVersion"), None) ),
        ( (0xC2A15278, 0xBFE74AFE, 0x6C1790FF, 0x531DF755).into(), (String::from("FLoadTimesObjectVersion"), None) ),
        ( (0x6EACA3D4, 0x40EC4CC1, 0xB7868BED, 0x9428FC5).into(),  (String::from("FGeometryObjectVersion"), None) ),
        ( (0x29E575DD, 0xE0A34627, 0x9D10D276, 0x232CDCEA).into(), (String::from("FAnimPhysObjectVersion"), None) ),
        ( (0xAF43A65D, 0x7FD34947, 0x98733E8E, 0xD9C1BB05).into(), (String::from("FAnimObjectVersion"), None) ),
        ( (0x6B266CEC, 0x1EC74B8F, 0xA30BE4D9, 0x0942FC07).into(), (String::from("FReflectionCaptureObjectVersion"), None) ),
        ( (0x0DF73D61, 0xA23F47EA, 0xB72789E9, 0x0C41499A).into(), (String::from("FAutomationObjectVersion"), None) ),
        ( (0x9DFFBCD6, 0x494F0158, 0xE2211282, 0x3C92A888).into(), (String::from("FEnterpriseObjectVersion"), None) ),
        ( (0xF2AED0AC, 0x9AFE416F, 0x8664AA7F, 0xFA26D6FC).into(), (String::from("FNiagaraObjectVersion"), None) ),
        ( (0x174F1F0B, 0xB4C645A5, 0xB13F2EE8, 0xD0FB917D).into(), (String::from("FDestructionObjectVersion"), None) ),
        ( (0x35F94A83, 0xE258406C, 0xA31809F5, 0x9610247C).into(), (String::from("FExternalPhysicsCustomObjectVersion"), None) ),
        ( (0xB68FC16E, 0x8B1B42E2, 0xB453215C, 0x058844FE).into(), (String::from("FExternalPhysicsMaterialCustomObjectVersion"), None) ),
        ( (0xB2E18506, 0x4273CFC2, 0xA54EF4BB, 0x758BBA07).into(), (String::from("FCineCameraObjectVersion"), None) ),
        ( (0x64F58936, 0xFD1B42BA, 0xBA967289, 0xD5D0FA4E).into(), (String::from("FVirtualProductionObjectVersion"), None) ),
        ( (0x6f0ed827, 0xa6094895, 0x9c91998d, 0x90180ea4).into(), (String::from("FMediaFrameworkObjectVersion"), None) ),
        ( (0xAFE08691, 0x3A0D4952, 0xB673673B, 0x7CF22D1E).into(), (String::from("FPoseDriverCustomVersion"), None) ),
        ( (0xCB8AB0CD, 0xE78C4BDE, 0xA8621393, 0x14E9EF62).into(), (String::from("FTempCustomVersion"), None) ),
        ( (0x2EB5FDBD, 0x01AC4D10, 0x8136F38F, 0x3393A5DA).into(), (String::from("FAnimationCustomVersion"), None) ),
        ( (0x717F9EE7, 0xE9B0493A, 0x88B39132, 0x1B388107).into(), (String::from("FAssetRegistryVersion"), None) ),
        ( (0xFB680AF2, 0x59EF4BA3, 0xBAA819B5, 0x73C8443D).into(), (String::from("FClothingAssetCustomVersion"), None) ),
        ( (0x4A56EB40, 0x10F511DC, 0x92D3347E, 0xB2C96AE7).into(), (String::from("FParticleSystemCustomVersion"), None) ),
        ( (0xD78A4A00, 0xE8584697, 0xBAA819B5, 0x487D46B4).into(), (String::from("FSkeletalMeshCustomVersion"), None) ),
        ( (0x5579F886, 0x933A4C1F, 0x83BA087B, 0x6361B92F).into(), (String::from("FRecomputeTangentCustomVersion"), None) ),
        ( (0x612FBE52, 0xDA53400B, 0x910D4F91, 0x9FB1857C).into(), (String::from("FOverlappingVerticesCustomVersion"), None) ),
        ( (0x430C4D19, 0x71544970, 0x87699B69, 0xDF90B0E5).into(), (String::from("FFoliageCustomVersion"), None) ),
        ( (0xaafe32bd, 0x53954c14, 0xb66a5e25, 0x1032d1dd).into(), (String::from("FProceduralFoliageCustomVersion"), None) ),
        ( (0xab965196, 0x45d808fc, 0xb7d7228d, 0x78ad569e).into(), (String::from("FLiveLinkCustomVersion"), None) ),
...
impl_custom_version_trait!(
    ...
    "FFortniteMainBranchObjectVersion",
    Guid::from_ints(0x601D1886, 0xAC644F84, 0xAA16D3DE, 0x0DEAC7D6),
...
impl_custom_version_trait!(
    ...
    "FFrameworkObjectVersion",
    Guid::from_ints(0xCFFC743F, 0x43B04480, 0x939114DF, 0x171D2073),
    VER_UE4_AUTOMATIC_VERSION: LatestVersion,
    VER_UE4_AUTOMATIC_VERSION_PLUS_ONE: VersionPlusOne,
...
impl_custom_version_trait!(
    FCoreObjectVersion,
    "FCoreObjectVersion",
    Guid::from_ints(0x375EC13C, 0x06E448FB, 0xB50084F0, 0x262A717E),
    VER_UE4_AUTOMATIC_VERSION: LatestVersion,
    VER_UE4_AUTOMATIC_VERSION_PLUS_ONE: VersionPlusOne,
...
impl_custom_version_trait!(
    ...
    "FAnimPhysObjectVersion",
    Guid::from_ints(0x29E575DD, 0xE0A34627, 0x9D10D276, 0x232CDCEA),
    VER_UE4_AUTOMATIC_VERSION: LatestVersion,
    VER_UE4_AUTOMATIC_VERSION_PLUS_ONE: VersionPlusOne,
...
impl_custom_version_trait!(
    ...
    "FReleaseObjectVersion",
    Guid::from_ints(0x9C54D522, 0xA8264FBE, 0x94210746, 0x61B482D0),
    VER_UE4_AUTOMATIC_VERSION: LatestVersion,
    VER_UE4_AUTOMATIC_VERSION_PLUS_ONE: VersionPlusOne,
...
impl_custom_version_trait!(
    ...
    "FSequencerObjectVersion",
    Guid::from_ints(0x7B5AE74C, 0xD2704C10, 0xA9585798, 0x0B212A5A),
    VER_UE4_AUTOMATIC_VERSION: LatestVersion,
    VER_UE4_AUTOMATIC_VERSION_PLUS_ONE: VersionPlusOne,
...
const ASSET_REGISTRY_VERSION_GUID: Guid =
    Guid::from_ints(0x717F9EE7, 0xE9B0493A, 0x88B39132, 0x1B388107);
